...
const ipcApiRoute = {
  ...
  //db
  getAllTableNames: 'controller.sqlitedb.getAllTableNames',
  getTableData: 'controller.sqlitedb.getTableData',
  getTableDataByField: 'controller.sqlitedb.getTableDataByField',
  getTableFieldValues: 'controller.sqlitedb.getTableFieldValues',
  getTableFields: 'controller.sqlitedb.getTableFields',
